...
class AppTheme {
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      primaryColor: const Color(0xFFff660b), // Tailwind blue-500
      useMaterial3: true,

      colorScheme: ColorScheme.fromSeed(
        seedColor: const Color(0xFFff660b),
        brightness: Brightness.light,
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color(0xFFff660b), // blue-500
          foregroundColor: Colors.white,
          disabledBackgroundColor: const Color(0xFFff660b).withAlpha(102),
